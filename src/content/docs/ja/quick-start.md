...
Webで画像直リンクを検索して取得してもよいですし、自分の画像を画像ホスティングへアップロードして直リンクを取得してもよいです。GitHubリポジトリやCloudFlareR2を使って長期的に安定した個人画像ホスティングを作ることもできます。個人画像ホスティングについては[こちら](self-hosted-image-solution.md)をクリックして詳しく確認できます。
